...
WebUI.setText(findTestObject('Object Repository/DGP-21/Reach Out Form_Submit/Reach Out Fields/Enter First Name'), 'TestFirstname')

WebUI.setText(findTestObject('Object Repository/DGP-21/Reach Out Form_Submit/Reach Out Fields/Enter Last Name'), '')

WebUI.click(findTestObject('Object Repository/DGP-21/Reach Out Form_Submit/Reach Out Fields/Enter Email'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyTextPresent('One or more fields have an error. Please check and try again.', true)
