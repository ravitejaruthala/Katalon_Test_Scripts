...
WebUI.setText(findTestObject('Object Repository/DGP-21/Reach Out Form_Submit/Reach Out Fields/Enter First Name'), 'Test First Name')
...
WebUI.verifyTextPresent('There was an error trying to send your message. Please try again later.', false)
